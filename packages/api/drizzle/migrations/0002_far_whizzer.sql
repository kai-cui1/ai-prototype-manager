...
ALTER TABLE "entity_fields" ALTER COLUMN "is_required" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "entity_fields" ALTER COLUMN "is_required" SET DATA TYPE boolean USING "is_required"::boolean;--> statement-breakpoint
