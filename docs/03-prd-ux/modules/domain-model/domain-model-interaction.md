...
| 画布设置 | IconButton | 新建实体右侧 | `Settings2` 图标（lucide-react），点击向左滑出配置侧边栏 |
...
- 尺寸：160px × 100px
- 节点映射：节点在 Minimap 中以缩略矩形展示，使用与画布相同的 category 颜色
...
| 画布容器 | `semantic-type="er-canvas"` | 当前可见的 nodes + edges |
