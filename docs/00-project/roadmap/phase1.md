...
| S3 | 技术方案设计 | `04-tech-design/` + `05-data-design/` |
| S4 | 测试用例设计 | `06-test-design/` |
| S5 | 代码实现 | `packages/` |
| S6 | 测试编写与验证 | `packages/api/tests/` + `packages/e2e/tests/` + 全绿闭环 |

> **注**：原 S3（高保真原型设计）已于 2026-05-20 取消，原 S4~S8 重新编号为 S3~S6。详见 AGENTS.md「关于 S3 高保真原型的决策」。
...
| 功能编号 | 名称 | P | S0 | S1 | S2 | S3 | S4 | S5 | S6 | 备注 |
|----------|------|:-:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|------|
...
| **F-M1-06** | 公司管理（CRUD/级联删除/解绑角色/统计/搜索/编辑Dialog/删除确认/Skeleton） | P0 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | API 22 TC + E2E 11/12 (2026-05-21) |
...
| 维度 | 总数 | ✅ | 🔶 | ⏳ | ⏸ | 完成率 |
|------|:----:|:--:|:--:|:--:|:--:|:------:|
| 功能点（顶层） | 10 | 6 | 0 | 3 | 1 | **60%** |
| 含子功能展开 | 14 | 7 | 0 | 6 | 1 | **50%** |
...
| 类别 | 文件数 | 用例数 | 通过率 |
|------|:-----:|:-----:|:-----:|
| API 测试 | 7 | 114 | 100%（F-M1-01~06: 107 + OpenAPI: 7） |
