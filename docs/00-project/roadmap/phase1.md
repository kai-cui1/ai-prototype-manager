...
|------|:----:|:------:|:------:|:------:|:--:|:--------:|:--------:|:--------:|
| 功能点（顶层） | 10 | 9 | 9 | 9 | 1 | **90%** | **90%** | **90%** |
| 含子功能展开 | 11 | 10 | 10 | 10 | 1 | **90%** | **90%** | **90%** |
...
| 类别 | 文件数 | 行数 | 说明 |
|------|:-----:|:----:|------|
| API Routes / Services | 4 | ~2,430 | organization.ts(419) + organization.service.ts(897) + projects.ts(194) + project.service.ts(367) + OpenAPI schema(29 端点) |
