...
| **F-M1-04** | 编辑项目基本信息（行内编辑/乐观锁） | P0 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏳ | ⏳ | ⏳ | 后端路由✅，待写测试+前端编辑UI |
...
| 维度 | 总数 | ✅ | 🔶 | ⏳ | ⏸ | 完成率 |
|------|:----:|:--:|:--:|:--:|:--:|:------:|
| 功能点（顶层） | 10 | 3 | 1 | 5 | 1 | **30%** |
| 含子功能展开 | 14 | 3 | 2 | 8 | 1 | **21%** |
...
| 类别 | 文件数 | 用例数 | 通过率 |
|------|:-----:|:-----:|:-----:|
| API 测试 | 4 | 51 | 100%（F-M1-01: 21 + F-M1-02: 20 + F-M1-03: 10） |
| E2E 测试 | 4 | 23 | 100%（smoke 3 + M1-01: 7 + M1-02: 2 + M1-03: 11） |
