...
| **F-M1-12** | 角色行为管理（actions JSONB + decisions JSONB） | P1 | ✅ | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | S2 PRD 待写 |
| **F-M1-13** | 外部实体行为管理（actions JSONB + decisions JSONB） | P1 | ✅ | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | S2 PRD 待写 |

### 完成率汇总

| 维度 | 总数 | S5完成 | S6完成 | S7完成 | ⏸ | S5完成率 | S6完成率 | S7完成率 |
|------|:----:|:------:|:------:|:------:|:--:|:--------:|:--------:|:--------:|
| 功能点（顶层） | 13 | 13 | 11 | 11 | 1 | **100%** | **85%** | **85%** |
| 含子功能展开 | 14 | 14 | 12 | 12 | 1 | **100%** | **86%** | **86%** |
...
| 类别 | 文件数 | 用例数 | 通过率 |
|------|:-----:|:-----:|:-----:|
| API 测试 | 15 | 271 | 100%（F-M1-01~06: 107 + F-M1-07~09: 82 + F-M1-11: 19 + M2: 55 + OpenAPI: 7 + 其他: 1） |
